...
document.addEventListener("DOMContentLoaded", function () {
    const svg = document.getElementById("martinB");
...
drawCircle(100, "solid", "#CDCDCD");
drawStar(250, 250, 5, 40, 25, "gold");

const svgElement = document.getElementById('martinB');
