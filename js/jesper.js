document.addEventListener("DOMContentLoaded", function () {
    const svg = document.getElementById("jesperB");
    ...
    mouth.setAttribute("d", "M160 240 a1,0.5 0 0,0 80,0");
...
drawCircle(100, "solid", "orange");
drawStar(250, 250, 5, 40, 25, "gold");

const svgElement = document.getElementById('jesperB');
