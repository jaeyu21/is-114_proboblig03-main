...
document.addEventListener("DOMContentLoaded", function () {
    const svg = document.getElementById("kajaB");
    ...
    mouth.setAttribute("d", "M160 240 a2,1 4 0,0 70,0");
...
drawCircle(100, "solid", "pink");
drawStar(250, 250, 5, 40, 25, "gold");

const svgElement = document.getElementById('kajaB');
